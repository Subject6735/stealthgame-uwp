...
namespace StealthGame.Model
{
    ...
    public class StealthGameModel
    {
        ...
        private int[,] _verticalArea;
        private int[,] _horizontalArea;
        ...
        /// </summary>
        public int[,] VisionConeArea { get { return _visionConeArea; } set { _visionConeArea = value; } }
        public int[,] VerticalArea { get { return _verticalArea; } set { _verticalArea = value; } }
        public int[,] HorizontalArea { get { return _horizontalArea; } set { _horizontalArea = value; } }
        public int[,] IntersectionArea { get { return _intersectionArea; } set { _intersectionArea = value; } }
        ...
        public void NewGame()
        {
            switch (_gameDifficulty)
            {
                case GameDifficulty.Easy:
                    GenerateFields("Levels/EasyLevel.txt");
                    break;
                case GameDifficulty.Medium:
                    GenerateFields("Levels/MediumLevel.txt");
                    break;
                case GameDifficulty.Hard:
                    GenerateFields("Levels/HardLevel.txt");
                    break;
            }
        ...
        public void SetVisionCone(int row, int col, StealthGameTable table)
        {
            ...
            _verticalArea = new int[_table.TableSize, _table.TableSize];
            ...
            _horizontalArea = new int[_table.TableSize, _table.TableSize];

            for (int i = 0; i < table.TableSize; ++i)
                for (int j = 0; j < table.TableSize; ++j)
                    _horizontalArea[i, j] = 0;
            ...
            _intersectionArea = new int[_table.TableSize, _table.TableSize];

            for (int i = 0; i < table.TableSize; ++i)
            {
                for (int j = 0; j < table.TableSize; ++j)
                {
                    _intersectionArea[i, j] = _verticalArea[i, j] + _horizontalArea[i, j];

                    if (_intersectionArea[i, j] == 2)
                    {
        ...
        private void GenerateFields(string path)
        {
            ...
            _verticalArea = new int[table.TableSize, table.TableSize];
            _horizontalArea = new int[table.TableSize, table.TableSize];
            _intersectionArea = new int[table.TableSize, table.TableSize];
            _visionConeArea = new int[table.TableSize, table.TableSize];
