...
namespace StealthGame.Test
{
    ...
    public class StealthGameModelTest
    {
        ...
        public void Model_NewGameMediumTest()
        {
            ...
            Assert.AreEqual(12, _model.Table.TableSize);
        }
        ...
        public void Model_NewGameHardTest()
        {
            ...
            Assert.AreEqual(14, _model.Table.TableSize);
        }
        ...
        public void Model_PlayerDetectedByPlayerMove()
        {
            ...
            _model.VisionConeArea = new int[_model.Table.TableSize, _model.Table.TableSize];
            _model.IntersectionArea = new int[_model.Table.TableSize, _model.Table.TableSize];
            _model.HorizontalArea = new int[_model.Table.TableSize, _model.Table.TableSize];
            _model.VerticalArea = new int[_model.Table.TableSize, _model.Table.TableSize];
